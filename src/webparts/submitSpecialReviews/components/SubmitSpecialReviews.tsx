...
export default class SubmitSpecialReviews extends React.Component<ISubmitSpecialReviewsProps, SubmitSpecialReviewsState, {}> {
  ...
  public async componentDidMount() {
    ...
    if (this.state.IsCreateMode) { }
      ...
      const SpecialReviewsDetails: TAG_SpecialReviews = await this.ListItemService.getItemUsingCAML(this.props.ItemID, [], undefined, Enums.ItemResultType.TAG_SpecialReview);
      this.setState({
        IsLoading: false,
  ...
  private validateSave(updateDetails: TAG_SpecialReviews): boolean {
    ...
    if (updateDetails.Title != "" && updateDetails.Title != undefined &&
      updateDetails.LeadMDNameEmail != "" && updateDetails.LeadMDNameEmail != undefined &&
      updateDetails.RevieweeNameEmail != "" && updateDetails.RevieweeNameEmail != undefined &&
      ...
      updateDetails.HoursWorked != "" && updateDetails.HoursWorked != undefined) {
        ...
        <div className={styles.submitSpecialReviews}>
          <div className={styles.container}>
            ...
            <div className={styles.row}>
              ...
              <div className={styles.row}>
                <div className={styles.lblTitle}> <Label><b>Project Name<span style={{ color: '#ff0000' }}>*</span></b></Label></div>
                <div className={styles.txtReviewIDs}><TextField resizable={false} multiline={false} value={this.state.SpecialReviews.Title} onChange={this.onChangeProjectName} ></TextField>   </div>
              </div>

              <div className={styles.row}>
                <div className={styles.lblTitle}> <Label><b>Reviewee Name<span style={{ color: '#ff0000' }}>*</span></b></Label></div>
              ...
              <div className={styles.row}>
                <div className={styles.lblTitle}> <Label><b>Lead MD Name<span style={{ color: '#ff0000' }}>*</span></b></Label></div>
                <div className={styles.txtReviewIDs}>
                  {<PeoplePicker
              ...
              <div className={styles.row}>
                <div className={styles.lblTitle}> <Label><b>Project Code<span style={{ color: '#ff0000' }}>*</span></b></Label></div>
                <div className={styles.txtReviewIDs}><TextField resizable={false} multiline={false} value={this.state.SpecialReviews.ProjectCode} onChange={this.onChangeProjectCode} ></TextField>   </div>
              </div>
              <div className={styles.row}>
                <div className={styles.lblTitle}> <Label><b>Client Name<span style={{ color: '#ff0000' }}>*</span></b></Label></div>
                <div className={styles.txtReviewIDs}><TextField resizable={false} multiline={false} value={this.state.SpecialReviews.ClientName} onChange={this.onChangeClientName} ></TextField>   </div>
              </div>
            </div>

            <div className={styles.row}>
              <div className={styles.lblTitle}> <Label><b>Project Start Date<span style={{ color: '#ff0000' }}>*</span></b></Label></div>
            ...
            <div className={styles.row}>
              <div className={styles.lblTitle}> <Label><b>Project End Date<span style={{ color: '#ff0000' }}>*</span></b></Label></div>
              <div className={styles.txtReviewIDs11}>
                <DateTimePicker
                  dateConvention={DateConvention.Date}
                  timeConvention={TimeConvention.Hours12}
            ...
            <div className={styles.row}>
              <div className={styles.lblTitle}> <Label><b>Hours Worked<span style={{ color: '#ff0000' }}>*</span></b></Label></div>
              <div className={styles.txtReviewIDs11}><TextField resizable={false} multiline={false} value={this.state.SpecialReviews.HoursWorked} onChange={this.onChangeHoursWorked} ></TextField>   </div>
            </div>
            <div className={styles.row}>
              <div className={styles.lblTitle}> <Label><b>Job Title  <br />(Determines review template)</b></Label></div>
              <div className={styles.txtReviewIDs11}>
                <Dropdown className={styles.dropServiceLine}
                  placeholder="Please select a value"
                  options={this.ServiceLineOptions} selectedKey={this.state.SpecialReviews.JobTitle}
                  onChange={(e, selectedOption) => { this.onChangeJobTitle(selectedOption.text); }} />
              </div>
            </div>
            <div className={styles.row}>
              <div className={styles.lblTitle}> <Label><b>Service Line:</b></Label></div>
              <div className={styles.txtReviewIDs11}>
                <Dropdown className={styles.dropServiceLine}
                  placeholder="Please select a value"
                  options={this.ServiceLines} selectedKey={this.state.SpecialReviews.ServiceLine}
                  onChange={(e, selectedOption) => { this.onChangeServiceLines(selectedOption.text); }} />
              </div>
            </div>
            <div className={styles.row}>
              <div className={styles.lblTitle}> <Label><b>Project Status</b></Label></div>
              <div className={styles.txtReviewIDs11}>
                <Dropdown className={styles.dropServiceLine}
                  placeholder="Please select a value"
                  options={this.ProjectStatusOptions} selectedKey={this.state.SpecialReviews.ProjectStatus}
                  onChange={(e, selectedOption) => { this.onChangeProjectStatus(selectedOption.text); }} />
              </div>
            </div>
            <div className={styles.row}>
              <div className={styles.lblTitle}> <Label><b>Last Hours Billed <br />(if known)</b></Label></div>
              <div className={styles.txtReviewIDs11}>
                <DateTimePicker
                  dateConvention={DateConvention.Date}
                  timeConvention={TimeConvention.Hours12}
