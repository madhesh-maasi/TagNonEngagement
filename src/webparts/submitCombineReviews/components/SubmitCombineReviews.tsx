...
import { DateConvention, DateTimePicker, TimeConvention, TimeDisplayControlType } from '@pnp/spfx-controls-react/lib/DateTimePicker';
...
export default class SubmitCombineReviews extends React.Component<ISubmitCombineReviewsProps, SubmitCombineReviewsState, {}> {
  ...
  public async componentDidMount() {
    ...
    if (this.state.IsCreateMode) { }
      ...
      const CombineReviewsDetails: TAG_CombineReviews = await this.ListItemService.getItemUsingCAML(this.props.ItemID, [], undefined, Enums.ItemResultType.TAG_CombinedReview);
      this.setState({
        IsLoading: false,
          ...
          <div className={styles.container}>
            ...
            <div className={styles.row}>
              <div className={styles.divCompetency}>
                <Label><b>INSTRUCTIONS: </b>Consult the list of eligible ID numbers at the bottom of the page. Then enter two or more of these ID numbers in the designated textbox below, separated by commas without spaces. Complete all other required information and submit to create a new Combined Review.</Label>
              </div>
              <div className={styles.divCompetency}>
                <Label>Note: Once a review has been combined into another review it can no longer be used. Use the combined review instead.</Label>
              </div>
              ...
              <div className={styles.row}>
                <div className={styles.lblReviewIDs}>
                  ...
                  <Label ><b>Review IDs to combine: <span style={{ color: '#ff0000' }}>*</span><br />
                    Separate with commas - no spaces. Example: 12,15,20</b></Label></div>
                <div className={styles.txtReview}><TextField resizable={false} multiline={false} value={this.state.CombineReviews.ReviewIDs} onChange={this.onChangeReviewIDs} ></TextField>   </div>
              </div>

              <div className={styles.row}>
                <div className={styles.lblReviewIDs}> <Label><b>Combined Review's Title </b> <span style={{ color: '#ff0000' }}>*</span></Label></div>
                <div className={styles.txtReview}><TextField resizable={false} multiline={false} value={this.state.CombineReviews.Title} onChange={this.onChangeTitleofCombinedReview} ></TextField>   </div>
              </div>

              <div className={styles.row}>
                <div className={styles.lblReviewIDs}> <Label><b>Client Name </b> <span style={{ color: '#ff0000' }}>*</span></Label></div>
                <div className={styles.txtReview}><TextField resizable={false} multiline={false} value={this.state.CombineReviews.ClientName} onChange={this.onChangeClientName} ></TextField>   </div>
              </div>

              <div className={styles.row}>
                <div className={styles.lblReviewIDs}> <Label><b>Service Line: </b><span style={{ color: '#ff0000' }}>*</span></Label></div>
                <div className={styles.txtReview}>
                  <Dropdown className={styles.dropServiceLine} options={this.ServiceLines} placeholder="Please Select a Value" selectedKey={this.state.CombineReviews.ServiceLine} onChange={(e, selectedOption) => { this.onChangeServiceLines(selectedOption.text); }} />

                </div>
              </div>

              <div className={styles.row}>
                <div className={styles.lblReviewIDs}> <Label><b>Project Start Date </b><span style={{ color: '#ff0000' }}>*</span></Label></div>
                <div className={styles.txtReview}>
                  <DateTimePicker
                ...
                <div className={styles.lblReviewIDs1}>
                  <Label><b>Last Date Hours Billed  <br />
                    (if known)</b></Label>
                </div>
                <div className={styles.txtReview}>
                  <DateTimePicker
              ...
              <div className={styles.row}>
                <div className={styles.lblReviewIDs}> <Label><b>Project End Date </b><span style={{ color: '#ff0000' }}>*</span></Label></div>
                <div className={styles.txtReview}>
                  <DateTimePicker
                    dateConvention={DateConvention.Date}
                    timeConvention={TimeConvention.Hours12}
                ...
                <div className={styles.lblReviewIDs1}>
                  <Label><b>Job Title of Combined Review <span style={{ color: '#ff0000' }}>*</span><br />
                    (This determines the review template)</b></Label></div>
                <div className={styles.txtReview}>
