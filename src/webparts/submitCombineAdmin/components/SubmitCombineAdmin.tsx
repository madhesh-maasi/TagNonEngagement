...
export default class SubmitCombineAdmin extends React.Component<ISubmitCombineAdminProps, SubmitCombineAdminState, {}> {
  //#region  ViewFields 
  ...
  public async componentDidMount() {
    ...
    if (this.state.IsCreateMode) { }
      ...
      const CombineAdminDetails: TAG_CombineAdmin = await this.ListItemService.getItemUsingCAML(this.props.ItemID, [], undefined, Enums.ItemResultType.TAG_CombineAdmin);
  ...
  private async onChangeReviewerName(items: any[]) {
    ...
    if (items != null && items.length > 0) {
      ...
      this.setState({ IsReviewerNameEnable : curretState.ReviewerName.Email != ""  ?  false :true});
  ...
  private onChangeClientName(event: React.FormEvent<HTMLInputElement | HTMLTextAreaElement>, newValueText: string): void {
    let curretState = this.state.CombineAdmin;
  ...
  private validateSave(updateDetails: TAG_CombineAdmin): boolean {
    ...
    if (updateDetails.Title != "" && updateDetails.Title != undefined
      && updateDetails.ReviewIDs != "" && updateDetails.ReviewIDs != undefined
      && updateDetails.ClientName != "" && updateDetails.ClientName != undefined
      && updateDetails.ServiceLine != "" && updateDetails.ServiceLine != undefined
      && updateDetails.ProjectStartDate != undefined
      && updateDetails.ProjectEndDate != undefined
      && updateDetails.JobTitle != "" && updateDetails.JobTitle != undefined) {
      valid = true;
    }
    return valid;
  }
  ...
  private async bindListView() {
    ...
    let _ProjectItem = await this.ProjectsListItemService.getProjectItemUsingCAML(this.state.CombineAdmin.ReviewerName.Id, [], undefined, Enums.ItemResultType.TAG_Projects);
            ...
            <div className={styles.row}>
              <div className={styles.lblTopText}>
                <div className={styles.divCompetency}>
                  <Label><b style={{ color: '#ff0000' }}>INSTRUCTIONS:</b> Choose a Reviewee whose reviews you want to combine. Then onsult the list of eligible ID numbers at the bottom of the page. Enter two or more of these ID numbers in the designated textbox below, separated by commas without spaces. Complete all other required information and submit to create a new Combined Review.
                  </Label>
                </div>
                <div className={styles.divCompetency}>
                  <Label><b >NOTE: </b>Once a review has been combined into another review it can no longer be used. Use the Combined Review instead.</Label>
                </div>
                <hr className={styles.hr}></hr>
              </div>
                ...
                {(this.state.IsCreateMode || this.state.hasEditItemPermission) &&
                  <div className={styles.txtReviewIDsTextBox}>
                    ...
                    className={styles.btnGETREVIEW}
                     ...
                     onClick={this.onGETREVIEWS} ></PrimaryButton>
                  </div>
                }
              </div>
              ...
              {(this.state.IsShowForm) &&
                <div>
                  <div style={{ paddingTop: '15px !important' }} className={styles.row}>
                    <div className={styles.lblTitle}>
                      <Label className={styles.lblText}><b>Review IDs to combine</b><span style={{ color: '#ff0000' }}>*</span><br />
                        <b>Separate with commas - no spaces. Example: 12,15,20</b></Label>
                    </div>
                    <div className={styles.txtReviewIDsTextBox1}><TextField onKeyPress={(e) => handleKeyPress(e)} resizable={false} multiline={false} value={this.state.CombineAdmin.ReviewIDs} onChange={this.onChangeReviewIDs} className={styles.Multilinetextarea}></TextField>   </div>
                  </div>

                  <div className={styles.row}>
                    <div className={styles.lblTitle}>
                      <Label><b>Combined Review's Title</b><span style={{ color: '#ff0000' }}>*</span></Label>
                    </div>
                    <div className={styles.txtReviewIDsTextBox1}><TextField resizable={false} multiline={false} value={this.state.CombineAdmin.Title} onChange={this.onChangeTitleofCombinedReview} className={styles.Multilinetextarea}></TextField>   </div>
                    <div style={{ width: '20% !important' }} className={styles.lblTitle}>
                      <Label><b>Last Date Hours Billed (If Known)</b></Label>
                    </div>
                  ...
                  <div className={styles.row}>
                    <div className={styles.lblTitle}>
                      <Label><b>Client Name </b> <span style={{ color: '#ff0000' }}>*</span></Label>
                    </div>
                    <div className={styles.txtReviewIDsTextBox1}>
                      <TextField resizable={false} multiline={false} value={this.state.CombineAdmin.ClientName} onChange={this.onChangeClientName} className={styles.Multilinetextarea}></TextField>
                    </div>
                    <div style={{ width: '20% !important' }} className={styles.lblTitle}>
                  ...
                  <div style={{ paddingTop: '15px !important' }} className={styles.row}>
                    <div className={styles.lblTitle}>
                      <Label><b>Service Line<span style={{ color: '#ff0000' }}>*</span></b></Label></div>
                    <div className={styles.txtReviewIDsTextBox1}>
                      <Dropdown className={styles.dropServiceLine}
                  ...
                  <div style={{ paddingTop: '15px !important' }} className={styles.row}>
                    <div className={styles.lblTitle}>
                      <Label><b>Project Start Date </b><span style={{ color: '#ff0000' }}>*</span></Label></div>
                    <div className={styles.txtReviewIDsTextBox1}>
                      <DateTimePicker
                        dateConvention={DateConvention.Date}
                        timeConvention={TimeConvention.Hours12}
                  ...
                  <div style={{ paddingTop: '15px !important' }} className={styles.row}>
                    <div className={styles.lblTitle}>
                      <Label><b>Project End Date </b><span style={{ color: '#ff0000' }}>*</span></Label></div>
                    <div className={styles.txtReviewIDsTextBox1}>
                      <DateTimePicker
                        dateConvention={DateConvention.Date}
                        timeConvention={TimeConvention.Hours12}
                  ...
                  <div className={styles.row}></div>
                  <div className={styles.row}> <Label className={styles.Viewlblfontsize}><b>Unstarted, Uncombined reviews.</b></Label></div>
                  <div>
                    <ListView
